<template>
  <div class="statistics-container">
    <!-- 顶部统计 -->
    <div class="statistics-top" style="background-color: rgba(60,173,245,0.9); padding: 15px;">
      <a-row :gutter="30">
    ...
    <a-col :span="30" class="to8">
      <a-card :bordered="true">
        <a-statistic title="CillianDevOps"   >
          <template #formatter>
            <a>运维开发管理平台操作须知：</a>
            <br>
            <a style="color: #c94922 ">1、生产环境谨慎操作!</a>
          </template>
        </a-statistic>
      </a-card>
    </a-col>
